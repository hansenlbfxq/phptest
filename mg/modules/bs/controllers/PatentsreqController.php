...
class PatentsreqController extends QrckController
{
    ...
    public function actionIndex()
    {
        ...
        $model = BsSdPatentReq::find()->where('status<9');
     ...
     * @access public
     * @since 1.0
     * @return BsSdPatentReq
     * @throws ServerErrorHttpException
     * @throws \yii\base\InvalidConfigException
     */
    public function actionCreate()
    {
        $model = new BsSdPatentReq();
