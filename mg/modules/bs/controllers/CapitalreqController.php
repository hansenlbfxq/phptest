...
class CapitalreqController extends QrckController
{
    ...
    public function actionIndex()
    {
        ...
        $model = BsSdCapitalReq::find()->where('status<9');
    ...
    public function actionView()
    {
        ...
        $data = BsSdCapitalReq::findOne($id);
        if ($data) {
            return $data;
        } else {
     ...
     * @access public
     * @since 1.0
     * @return BsSdCapitalReq
     * @throws ServerErrorHttpException
     * @throws \yii\base\InvalidConfigException
     */
    public function actionCreate()
    {
        $model = new BsSdCapitalReq();
    ...
    public function actionStatus()
    {
        ...
        if (empty($ids) || empty($status)) {
            ...
            $ids = explode(",", $ids);
            foreach ($ids as $i) {
                $model = BsSdCapitalReq::findOne($i);
